...
const {activityHandler} = require("./presenceHandler/activityHandler");
...
module.exports.createPresenceTheme1 = createPresenceTheme1;
...
async function defaultInfo(user, logo_black = false, color) {
    // create new Canvas
...
async function createPresenceTheme1(client, user, presence) {
    let activityCanvas, avatarCanvas, defaultInfoCanvas;
    ...
    // draw the status test and activity
    activityCanvas = await activityHandler(presence, status_text, color);
    ...
    // TODO: Implement
    const logo_black = false;

    defaultInfoCanvas = await defaultInfo(user, logo_black, color);
    ctx.drawImage(defaultInfoCanvas, 0, 0);
...
async function createPresenceTheme2(client, user, presence) {
