...
module.exports = { //if [OPTIONAL] it means, you don't need to type it!
  ...
  requiredroles: ["928998412584620116"], //Only allow specific Users with a Role to execute a Command [OPTIONAL]
  alloweduserids: [], //Only allow specific Users to execute a Command [OPTIONAL]
  minargs: 0, // minimum args for the message, 0 == none [OPTIONAL]
  maxargs: 0, // maximum args for the message, 0 == none [OPTIONAL]
  minplusargs: 1, // minimum args for the message, split with "++" , 0 == none [OPTIONAL]
  maxplusargs: 0, // maximum args for the message, split with "++" , 0 == none [OPTIONAL]
  argsmissing_message: "", //Message if the user has not enough args / not enough plus args, which will be sent, leave empty / dont add, if you wanna use command.usage or the default message! [OPTIONAL]
  argstoomany_message: "", //Message if the user has too many / not enough args / too many plus args, which will be sent, leave empty / dont add, if you wanna use command.usage or the default message! [OPTIONAL]
